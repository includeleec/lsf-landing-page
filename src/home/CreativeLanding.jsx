...
const SlideList = [
    {
        ...
        category: '欢迎加入',
        title: 'LOSS.Finance ',
        description: '在DEFI世界里，土狗是仿盘的意思，LSF也是模仿了safemoon，pig等项目，并进行魔改创新在我们的价值观里，土狗代表实诚，不坑不骗是底线，也喜欢坐等发财。',
                ...
                <header className="header-area formobile-menu header--fixed default-color">
                    <div className="header-wrapper" id="header-wrapper">
                        <div className="header-left">
                            <div className="logo">
                                <a href="/">
                                    <img className="" src="/assets/images/logo/lsf-logo.png" alt="Logo Images" style={{width: 50,height: 50}} />
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className={`inner ${value.textPosition}`}>
                                                ...
                                                {value.description ? <p className="description" sytle={{fontSize: 14}}>{value.description}</p> : ''}
                                ...
                                <div className="col-lg-12">
                                    <div className="about-inner inner">
                                        <div className="section-title">
                                            <h3 className="title" style={{color: '#f00'}}>郑重声明</h3>
                                            <p className="description" style={{color: '#000'}}>程序员水平有限，代码可能有导致归零的风险，通过安全审计后开源，别重仓！别重仓！别重仓！</p>
                                        </div>
